...
const BookForm = ({ data, bookId }) => {
    ...
    const customSubmit = (dataForm) => {
        ...
        if (isEdit) { 
            axios
                .put(`https://backendmintic-production.up.railway.app/books/edit/${bookId}`, bookObject)
                .then(response => console.log(response.data))
        } else {
            axios
                .post(`https://backendmintic-production.up.railway.app/books/create`, bookObject)
                .then(response => console.log(response.data))
        }
    }
